    ...
    def can_move(self, move, board):
        ...
        if ((distance == 1 and distance == math.sqrt(2)) and
            ...
            return True
              ...
              not self.vulnerable(7, 4, board) and not self.vulnerable(7, 5, board) and not self.vulnerable(7, 6, board)):
            ...
            return True
              ...
              not self.vulnerable(7, 2, board) and not self.vulnerable(7, 3, board) and not self.vulnerable(7, 6, board)):
            ...
            return True
              ...
              not self.vulnerable(0, 4, board) and not self.vulnerable(0, 5, board) and not self.vulnerable(0, 6, board)):
            ...
            return True
              ...
              not self.vulnerable(0, 2, board) and not self.vulnerable(0, 3, board) and not self.vulnerable(0, 6, board)):
